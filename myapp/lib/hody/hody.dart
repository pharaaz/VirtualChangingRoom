...
class hodyScreen extends StatefulWidget {
  const hodyScreen({super.key});

  @override
  State<hodyScreen> createState() => _hodyScreen();
}

class _hodyScreen extends State<hodyScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color.fromARGB(199, 199, 188, 216),
      appBar: AppBar(),
